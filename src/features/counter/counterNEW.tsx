...
import { Alert, Button, Dimensions, FlatList,  SafeAreaView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
import type { RootState } from '../../Redux/app/store'
import { funcIncrement, funcDecrement, funcIncrementByAmount } from './counterSlice'
let i = 0;
...
const listData = useSelector((state : RootState) =>{
      if(state.rootReducer.apireducer.apiname === 'testapinew'){
        return state.rootReducer.apireducer.apiData ? state.rootReducer.apireducer.apiData : [];;
      }  
    } );
  useEffect(() =>{
